...
<jstl:if test="${command!='update'}">
	...
	<acme:form-submit test="${command == 'show'}" code="employer.job.form.button.accepted" action="/employer/application/update?id=${id}" method = "get"/>
	...
	<acme:form-submit test="${status!='accepted' && command == 'show'}" code="employer.job.form.button.accepted" action="/employer/application/update?nstatus=accepted&id=${id}" method = "get"/>
	<acme:form-submit test="${status!='rejected' && command == 'show'}" code="employer.job.form.button.rejected" action="/employer/application/update?nstatus=rejected&id=${id}" method = "get"/>
	<acme:form-submit test="${command == 'update'}" code="employer.job.form.button.reason" action="/employer/application/update"/>
  	<acme:form-return code="employer.application.form.button.return"/>
</acme:form>